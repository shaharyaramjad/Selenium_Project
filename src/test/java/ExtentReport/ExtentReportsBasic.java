...
public class ExtentReportsBasic implements ITestListener {

    protected static com.relevantcodes.extentreports.ExtentReports reports;
    protected static com.relevantcodes.extentreports.ExtentTest test;
    ...
    private static String getResultPath() {
        ...
        resultpath = "ExtentReport";//new SimpleDateFormat("yyyy-MM-dd hh-mm.ss").format(new Date());
